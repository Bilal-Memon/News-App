...
class _PopularNewsState extends State<PopularNews> {
  ...
  final customCacheManager =
      CacheManager(Config('PopularCacheKey', stalePeriod: Duration(days: 2)));
  ...
  getUser() async {
    ...
    var response = await http.get(Uri.parse(
        'https://newsapi.org/v2/everything?language=en&q=news&from=$dateFrom&pageSize=30&sortBy=popularity&apiKey=2d994719819c49a483538246c73c74ab'));
