...
class _HeadLinesState extends State<HeadLines> {
  ...
  final customCacheManager =
      CacheManager(Config('headlineCacheKey', stalePeriod: Duration(days: 2)));

  getUser() async {
    var db = FirebaseFirestore.instance;
    var response = await http.get(Uri.parse(
        'https://newsapi.org/v2/top-headlines?language=en&country=sa&pageSize=30&apiKey=2d994719819c49a483538246c73c74ab'));
